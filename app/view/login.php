...
<body class="bg-[#FAF9F6] text-[#1C1C1C] font-sans">
    ...
    <main>
        <div class="bg-white p-8 rounded-lg shadow-md max-w-md w-full" data-aos="fade-up">
            <h1 class="text-2xl font-bold text-center text-[#1C1C1C] mb-6">Login</h1>
            <form action="auth.php" method="POST">
                ...
                <button type="submit" class="w-full bg-[#3FA7A3] text-white py-2 px-4 rounded-lg font-semibold hover:bg-[#2F8F8B]">Entrar</button>
            </form>
            <p class="mt-4 text-sm text-center text-[#4F4F4F]">
                Não tem uma conta? <a href="register.php" class="text-[#F57C00] font-semibold hover:underline">Cadastre-se</a>
            </p>
        </div>
    </main>
